...
from read_obj_det_imgs import get_bounds, is_small, get_center, get_bottom_images, get_top_images, get_right_images
...
if __name__ == '__main__':
    ...
    width_w = 17.14320627312233
    height_w = 16.54026526825823
    ...
    for t, test in enumerate(testdata):
        # if t == 196 or t == 396 or t == 513 or t == 894 or t == 1134 or t == 1256 or t == 1320 or t == 1428 or t == 1775 or t == 2002 or t == 2107 or t == 2375:
        #     print(inp)
        #     continue
        ...
        for i, score in enumerate(test['score_det_raw']):
            ...
            width_interval = (y_coord - height_w, y_coord + height_w)
        ...
        true_output = get_top_images(test['bbox_gt'], 100)
        # print('Actual number: ' + str(true_output))
        predicted_output = get_top_images(test['bbox_det_raw'], 100)
        concreteOutput = (predicted_output - w4, predicted_output + w4)
    ...
    plt.savefig('predintervals/intervalLengths/top_100_comparison' +'.png', dpi=1200)
    ...
    # plt.ylim((0.2,1.05))
    plt.legend()
    plt.savefig('predintervals/intervalCoverage/top_100_comparison' +'.png', dpi=1200)
